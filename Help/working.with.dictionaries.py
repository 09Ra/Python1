...
for dct_i in dictionary_1:                    # Походимся по элементам списка, т.е по словорям
    print(dct_i.items())                      # Выводит картежи 
    print(dct_i.values())                     # Выводит только значения  
    print(dct_i.keys())                       # Выводит только ключи
    print(*dct_i.values())                    # Выводит то что мы хотим распаковав
    print(dct_i)                              # Вводит последний элемент при сортировке  
