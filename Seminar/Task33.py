...
# def invertMaxMarks(marks):   # Создаем функцию, которая находит максимальную оценку и заменяет ее на минимальную оценку и возвращает ее
...
# Решение №2 с засеканием времени
import random
from random import randint
import time
